...
#ifndef RADIUM_RADIUM_ELF_THIRD_PARTY_DLLS_BEACON_H_
#define RADIUM_RADIUM_ELF_THIRD_PARTY_DLLS_BEACON_H_
...
#endif  // RADIUM_RADIUM_ELF_THIRD_PARTY_DLLS_BEACON_H_
