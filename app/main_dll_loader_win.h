...
#ifndef RADIUM_APP_MAIN_DLL_LOADER_WIN_H_
#define RADIUM_APP_MAIN_DLL_LOADER_WIN_H_
...
class MainDllLoader {
 public:
  ...
  void RelaunchRadiumWithNewCommandLineIfNeeded();
...
#endif  // RADIUM_APP_MAIN_DLL_LOADER_WIN_H_
