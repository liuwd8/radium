...
#ifndef RADIUM_INSTALL_STATIC_PRODUCT_INSTALL_DETAILS_H_
#define RADIUM_INSTALL_STATIC_PRODUCT_INSTALL_DETAILS_H_
...
#endif  // RADIUM_INSTALL_STATIC_PRODUCT_INSTALL_DETAILS_H_
