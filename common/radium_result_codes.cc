...
bool IsNormalResultCode(ResultCode code) {
  ...
  // here.
  if (code == RADIUM_RESULT_CODE_NORMAL_EXIT_UPGRADE_RELAUNCHED ||
      code == RADIUM_RESULT_CODE_NORMAL_EXIT_PACK_EXTENSION_SUCCESS ||
      code == RADIUM_RESULT_CODE_NORMAL_EXIT_PROCESS_NOTIFIED) {
    return true;
  }
