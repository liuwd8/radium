...
#ifndef RADIUM_BROWSER_PROCESS_SINGLETON_STARTUP_LOCK_H_
#define RADIUM_BROWSER_PROCESS_SINGLETON_STARTUP_LOCK_H_
...
#endif  // RADIUM_BROWSER_PROCESS_SINGLETON_STARTUP_LOCK_H_
