...
#ifndef RADIUM_BROWSER_RADIUM_PROCESS_SINGLETON_H_
#define RADIUM_BROWSER_RADIUM_PROCESS_SINGLETON_H_

#include "base/files/file_path.h"
#include "base/functional/callback.h"
#include "radium/browser/process_singleton.h"
#include "radium/browser/process_singleton_startup_lock.h"
...
class RadiumProcessSingleton {
 public:
  explicit RadiumProcessSingleton(const base::FilePath& user_data_dir);

  RadiumProcessSingleton(const RadiumProcessSingleton&) = delete;
  RadiumProcessSingleton& operator=(const RadiumProcessSingleton&) = delete;

  ~RadiumProcessSingleton();
  ...
  static RadiumProcessSingleton* GetInstance();
...
#endif  // RADIUM_BROWSER_RADIUM_PROCESS_SINGLETON_H_
