...
#ifndef RADIUM_BROWSER_BADGING_BADGE_MANAGER_DELEGATE_H_
#define RADIUM_BROWSER_BADGING_BADGE_MANAGER_DELEGATE_H_
...
#endif  // RADIUM_BROWSER_BADGING_BADGE_MANAGER_DELEGATE_H_
