...
#import "radium/browser/ui/views/tab_contents/radium_web_contents_view_delegate_views_mac.h"
...
// #include
// "chrome/browser/ui/cocoa/tab_contents/web_drag_bookmark_handler_mac.h"
// #include "chrome/browser/ui/sad_tab_helper.h"
// #include "chrome/browser/ui/tab_contents/chrome_web_contents_menu_helper.h"
// #include
// "chrome/browser/ui/tab_contents/chrome_web_contents_view_handle_drop.h"
...
RadiumWebContentsViewDelegateViewsMac::RadiumWebContentsViewDelegateViewsMac(
...
RadiumWebContentsViewDelegateViewsMac::
    ~RadiumWebContentsViewDelegateViewsMac() = default;
...
RadiumWebContentsViewDelegateViewsMac::GetDelegateForHost(
...
RadiumWebContentsViewDelegateViewsMac::GetDragDestDelegate() {
  // return bookmark_handler_.get();
  return nullptr;
}

void RadiumWebContentsViewDelegateViewsMac::ShowContextMenu(
...
void RadiumWebContentsViewDelegateViewsMac::StoreFocus() {
  GetFocusHelper()->StoreFocus();
}

bool RadiumWebContentsViewDelegateViewsMac::RestoreFocus() {
  return GetFocusHelper()->RestoreFocus();
}

void RadiumWebContentsViewDelegateViewsMac::ResetStoredFocus() {
  GetFocusHelper()->ResetStoredFocus();
}

bool RadiumWebContentsViewDelegateViewsMac::Focus() {
  return GetFocusHelper()->Focus();
}

bool RadiumWebContentsViewDelegateViewsMac::TakeFocus(bool reverse) {
  return GetFocusHelper()->TakeFocus(reverse);
}

void RadiumWebContentsViewDelegateViewsMac::OnPerformingDrop(
...
RadiumWebContentsViewDelegateViewsMac::BuildMenu(
    content::RenderFrameHost& render_frame_host,
    const content::ContextMenuParams& params) {
...
void RadiumWebContentsViewDelegateViewsMac::ShowMenu(
...
RadiumWebContentsViewDelegateViewsMac::GetActiveRenderWidgetHostView() const {
  return web_contents_->GetTopLevelRenderWidgetHostView();
}

RadiumWebContentsViewFocusHelper*
RadiumWebContentsViewDelegateViewsMac::GetFocusHelper() const {
...
std::unique_ptr<content::WebContentsViewDelegate> CreateWebContentsViewDelegate(
    content::WebContents* web_contents) {
  return std::make_unique<RadiumWebContentsViewDelegateViewsMac>(web_contents);
}
