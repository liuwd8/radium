...
#include "radium/browser/ui/views/hover_button_controller.h"
...
std::unique_ptr<views::Border> CreateBorderWithVerticalSpacing(
  ...
  const int horizontal_spacing = RadiumLayoutProvider::Get()->GetDistanceMetric(
...
int GetVerticalSpacing() {
  return RadiumLayoutProvider::Get()->GetDistanceMetric(
