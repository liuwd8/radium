...
#ifndef RADIUM_BROWSER_UI_VIEWS_CONTROLS_HOVER_BUTTON_H_
#define RADIUM_BROWSER_UI_VIEWS_CONTROLS_HOVER_BUTTON_H_
...
class HoverButton : public views::LabelButton {
 ...
 public:
  ...
  HoverButton(
      ...
      int icon_label_spacing = RadiumLayoutProvider::Get()->GetDistanceMetric(
...
#endif  // RADIUM_BROWSER_UI_VIEWS_CONTROLS_HOVER_BUTTON_H_
