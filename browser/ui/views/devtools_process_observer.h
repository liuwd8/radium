...
#ifndef RADIUM_BROWSER_UI_VIEWS_DEVTOOLS_PROCESS_OBSERVER_H_
#define RADIUM_BROWSER_UI_VIEWS_DEVTOOLS_PROCESS_OBSERVER_H_
...
#endif  // RADIUM_BROWSER_UI_VIEWS_DEVTOOLS_PROCESS_OBSERVER_H_
