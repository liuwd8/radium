...
#ifndef RADIUM_BROWSER_UI_VIEWS_DARK_MODE_MANAGER_LINUX_H_
#define RADIUM_BROWSER_UI_VIEWS_DARK_MODE_MANAGER_LINUX_H_
...
#endif  // RADIUM_BROWSER_UI_VIEWS_DARK_MODE_MANAGER_LINUX_H_
