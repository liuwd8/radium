...
int RadiumViewsDelegate::GetAppbarAutohideEdges(HMONITOR monitor,
  ...
  if (monitor && !in_autohide_edges_callback_) {
    ...
    base::ThreadPool::PostTaskAndReplyWithResult(
        ...
        base::BindOnce(&RadiumViewsDelegate::OnGotAppbarAutohideEdges,
...
void RadiumViewsDelegate::OnGotAppbarAutohideEdges(base::OnceClosure callback,
                                                   HMONITOR monitor,
                                                   int returned_edges,
                                                   int edges) {
