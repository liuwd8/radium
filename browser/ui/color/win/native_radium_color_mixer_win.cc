...
void FrameColorHelper::AddNativeChromeColors(
  ...
  // constexpr SkColor kSystemMicaDarkFrameColor = SkColorSetRGB(0x20, 0x20,
  // 0x20);
...
color_utils::HSL FrameColorHelper::GetTint(
  ...
  // // Always pass false for |incognito| here since the ColorProvider is
  // treating
  // // incognito mode as dark mode. If this needs to change, that information
  // will
...
void AddNativeChromeColorMixer(ui::ColorProvider* provider,
  ...
  // {ui::kColorNativeHighlight}; mixer[kColorOmniboxResultsIcon] =
  // {kColorOmniboxText}; mixer[kColorOmniboxResultsIconSelected] =
  // {kColorOmniboxResultsTextSelected}; mixer[kColorOmniboxResultsTextDimmed] =
  // {kColorOmniboxText}; mixer[kColorOmniboxResultsTextDimmedSelected] = {
