...
#ifndef RADIUM_BROWSER_UI_PROCESS_SINGLETON_DIALOG_LINUX_H_
#define RADIUM_BROWSER_UI_PROCESS_SINGLETON_DIALOG_LINUX_H_
...
#endif  // RADIUM_BROWSER_UI_PROCESS_SINGLETON_DIALOG_LINUX_H_
