...
#ifndef RADIUM_BROWSER_NET_PROFILE_NETWORK_CONTEXT_SERVICE_H_
#define RADIUM_BROWSER_NET_PROFILE_NETWORK_CONTEXT_SERVICE_H_
...
#endif  // RADIUM_BROWSER_NET_PROFILE_NETWORK_CONTEXT_SERVICE_H_
