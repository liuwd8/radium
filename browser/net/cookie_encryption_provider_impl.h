...
#ifndef RADIUM_BROWSER_NET_COOKIE_ENCRYPTION_PROVIDER_IMPL_H_
#define RADIUM_BROWSER_NET_COOKIE_ENCRYPTION_PROVIDER_IMPL_H_
...
#endif  // RADIUM_BROWSER_NET_COOKIE_ENCRYPTION_PROVIDER_IMPL_H_
