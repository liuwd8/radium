...
#ifndef RADIUM_BROWSER_NET_STUB_RESOLVER_CONFIG_READER_H_
#define RADIUM_BROWSER_NET_STUB_RESOLVER_CONFIG_READER_H_
...
#endif  // RADIUM_BROWSER_NET_STUB_RESOLVER_CONFIG_READER_H_
