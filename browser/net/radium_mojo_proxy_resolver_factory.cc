...
RadiumMojoProxyResolverFactory::RadiumMojoProxyResolverFactory() = default;

RadiumMojoProxyResolverFactory::~RadiumMojoProxyResolverFactory() {
...
RadiumMojoProxyResolverFactory::CreateWithSelfOwnedReceiver() {
  ...
  mojo::MakeSelfOwnedReceiver(
      std::make_unique<RadiumMojoProxyResolverFactory>(),
      remote.InitWithNewPipeAndPassReceiver());
  return remote;
}

void RadiumMojoProxyResolverFactory::CreateResolver(
