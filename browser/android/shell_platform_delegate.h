...
#ifndef RADIUM_BROWSER_ANDROID_SHELL_PLATFORM_DELEGATE_H_
#define RADIUM_BROWSER_ANDROID_SHELL_PLATFORM_DELEGATE_H_
...
class ShellPlatformDelegate {
 public:
  ...
  virtual std::unique_ptr<content::JavaScriptDialogManager>
  ...
  virtual std::unique_ptr<content::ColorChooser> OpenColorChooser(
      content::WebContents* web_contents,
      SkColor color,
  ...
  virtual void ActivateContents(Shell* shell, content::WebContents* contents);

  virtual void DidNavigatePrimaryMainFramePostCommit(
      Shell* shell,
...
#endif  // RADIUM_BROWSER_ANDROID_SHELL_PLATFORM_DELEGATE_H_
