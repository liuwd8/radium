...
#ifndef RADIUM_BROWSER_WIN_REMOVE_APP_COMPAT_ENTRIES_H_
#define RADIUM_BROWSER_WIN_REMOVE_APP_COMPAT_ENTRIES_H_
...
#endif  // RADIUM_BROWSER_WIN_REMOVE_APP_COMPAT_ENTRIES_H_
