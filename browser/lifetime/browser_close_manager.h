...
#ifndef RADIUM_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
#define RADIUM_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
...
#endif  // RADIUM_BROWSER_LIFETIME_BROWSER_CLOSE_MANAGER_H_
