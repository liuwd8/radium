...
#ifndef RADIUM_BROWSER_BROWSER_PROCESS_PLATFORM_PART_MAC_H_
#define RADIUM_BROWSER_BROWSER_PROCESS_PLATFORM_PART_MAC_H_
...
#endif  // RADIUM_BROWSER_BROWSER_PROCESS_PLATFORM_PART_MAC_H_
